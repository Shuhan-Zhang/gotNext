...
//   cloud.database().collection("game").doc(event.actionFilter._id).get()
//   .then(res=>{
...
//         }
//       }).then(res=>{
//         console.log("successfully removed team stats",res)
//       }).catch(err=>{
//         console.log("failed to removed team stats", err)
//       })
...
//         }
//       }).then(res=>{
//         console.log("successfully removed player stats",res)
//       }).catch(err=>{
//         console.log("failed to removed player stats", err)
//       })
//     })
